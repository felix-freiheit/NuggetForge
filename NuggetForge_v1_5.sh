...
# NuggetForge v1.5: Fully Bundled Edition (Intel macOS)
...
clear
echo -e "${PURPLE}=====================================${RESET}"
echo -e "${PURPLE}          NuggetForge v1.5          ${RESET}"
echo -e "${PURPLE}  Fully Bundled MacOS Builder      ${RESET}"
echo -e "${PURPLE}=====================================${RESET}"
...
# Build with full resource bundling

echo -e "${YELLOW}Building NuggetApp...${RESET}"
pyinstaller --clean --onedir --windowed --name NuggetApp --add-data "files:files" main_app.py > buildlog.txt 2>&1 &
PID=$!
TOTAL_BUILD=40
PROGRESS=0
...
echo -e "${PURPLE}=====================================${RESET}"
echo -e "${PURPLE}         NuggetForge v1.5 Done       ${RESET}"
echo -e "${PURPLE}=====================================${RESET}"
